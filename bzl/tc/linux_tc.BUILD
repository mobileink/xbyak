...
filegroup(
    ...
    srcs = glob(
        [
            ...
            "x86_64-unknown-linux-gnu/x86_64-unknown-linux-gnu/include/**/*.h",
            "x86_64-unknown-linux-gnu/sysroot/include/**/*.h",
            "x86_64-unknown-linux-gnu/sysroot/usr/include/*.h",
            "x86_64-unknown-linux-gnu/sysroot/usr/include/*.h",
            "x86_64-unknown-linux-gnu/include/c++/**/*h"
        ]
        + ["x86_64-unknown-linux-gnu/lib/gcc/x86_64-unknown-linux-gnu/6.3.0/include/stddef.h"]
        ,
    ),
)
